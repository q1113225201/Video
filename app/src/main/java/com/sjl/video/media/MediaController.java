...
public class MediaController extends FrameLayout {
    ...
    private void updatePausePlay() {
        ...
        if (mPlayer.isPlaying()) {
            mPauseButton.setImageResource(R.mipmap.weike_player_play_can_pause);
            mTvPlay.setImageResource(R.mipmap.ic_tv_stop);
        } else {
            mPauseButton.setImageResource(R.mipmap.weike_player_play_can_play);
